<script>
	...
	onMount(() => {
        const boardgamesCountUp = new CountUp('boardgames', boardgamesCounter, { enableScrollSpy: true, duration: 8 }),
            workshopsCountUp = new CountUp('workshops', workshopsCounter, { enableScrollSpy: true, duration: 12 }),
            tournamentCountUp = new CountUp('tournament', tournamentsCounter, { enableScrollSpy: true, duration: 12 }),
